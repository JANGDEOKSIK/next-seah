...
export default function OnlineSubmitForm() {
  ...
  useGSAP(
    () => {
      const height = titleRef?.current[0]?.offsetHeight;
      console.log(height, "height");

      titleRef?.current.map((el) => console.log(el, "el"));

      console.log(titleRef?.current, "titleRef");
      titleRef?.current.map((el) => {
        console.log(el.offsetHeight, "dfligj");
        ...
        gsap.to(el, {
          scrollTrigger: {
            ...
            markers: true,
            start: "top 150rem",
            end: `bottom -=${el.parentNode.offsetHeight + el.offsetHeight}`,
            pin: el,
            // endTrigger: el,
            pinSpacing: false,
          },
  ...
  return (
    <form
      ...
      ref={container1}
    >
      <div className="form-wrap form1">
        <div
          className="form-title f-tit2 form-title1"
          // ref={ref}
        >
          <div
            className="title"
      ...
      <div className="form-wrap pdt-long">
        ...
        <div className="form-area">
          ...
          <div className="bullet-list-wrap">
            ...
            <div className="bullet-list">
              비밀번호 찾기 기능이 제공되지 않으므로 진행 및 결과확인을 위해 꼭
              기억하시기 바랍니다.
            </div>
          </div>
        </div>
                ...
                <div className="scroll-content">
                  ...
                  <div className="terms">
                    ...
                    <div className="terms-txt">
                      ...
                      사실조사를 위한 연락·통지, 고객에 대한 답변, 처리결과 통보
                    </div>
                  </div>
                  <div className="terms">
                    <div className="terms-tit">개인정보 처리 및 보유 기간</div>
                    <div className="terms-txt">- 보유기간: 3년</div>
                    <div className="terms-txt">
                      - 회사는 개인정보의 수집·이용 목적이 달성되거나
                      고객으로부터 동의받은 개인정보 보유·이용기간이 만료된 경우
              ...
              <div className="radio-wrap">
                ...
                <div className="radio-group">
                  <div className="radio">
                    ...
                    />
                    <label htmlFor="personalInfoDisAgree">동의하지 않음</label>
                  </div>
                  <div className="radio">
                    <input
                      type="radio"
                ...
                <div className="scroll-content">
                  <div className="terms">
                    ...
                    <div className="terms-tit">
                      ...
                      관한 사항인 경우, 고객에 대한 원활한 서비스 제공을 위하여
                      해당 계열회사에 고객의 개인정보를 제공할 수 있습니다. 이
                      경우 고객으로부터 미리 동의를 받을 것입니다.
                    </div>
                    <div className="terms-txt">
                      - 제공 받는 자 : 제보된 계열 회사
                    </div>
                  ...
                  <div className="terms">
                    <div className="terms-tit">
                      나. 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진
